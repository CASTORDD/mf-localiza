...
const remotesMap = {
'users':{url:'http://localhost:3001/assets/remoteEntry.js',format:'esm',from:'vite'}
};
...
const RemoteUsersList = lazy(() => __federation_method_getRemote("users" , "./UsersList").then(module=>__federation_method_wrapDefault(module, true)));
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontFamily: "sans-serif", padding: "2rem" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Host App" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
      "The following component is loaded from the ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "users" }),
      " remote:"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Loading users module..." }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(RemoteUsersList, {}) })
  ] });
}
