...
// Windows temporarily needs this file, https://github.com/module-federation/vite/issues/68
    ...
    const importMap = {
        ...
        "react": async () => {
          let pkg = await import("__mf__virtual/__mfe_internal__users__prebuild__react__prebuild__.js");
            return pkg;
        }
      ,
        "react-dom": async () => {
          let pkg = await import("__mf__virtual/__mfe_internal__users__prebuild__react_mf_2_dom__prebuild__.js");
            return pkg;
        }
